...
const Contact = () => {
  ...
  // Prepare Cal UI (same as Home CTA)
  useEffect(() => {
    (async function () {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      details: 'support@zenstart.net',
      description: 'Send us an email anytime',
    },
    {
      icon: Phone,
      title: 'Phone',
      details: '+1 (807) 788-8126',
      description: 'Call us during business hours',
    },
    {
      icon: MapPin,
      title: 'Location',
      details: 'North York, ON Toronto',
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {isCalOpen && (
                    <div ref={calRef} className="mt-6">
                      <h4 className="text-2xl font-thin mb-4 bg-gradient-to-r from-[#A1BFFF] via-white to-[#A649D2] bg-clip-text text-transparent">
